...
import { getMultipleTests,deleteMultipleTest } from './service';
...
const handleRemove = async (selectedRows: TableListItem[]) => {
  ...
  try {
    ...
    const res = await deleteMultipleTest(ids);
    if (res.status !== 'error') {
      hide();
  ...
  return (
    <PageHeaderWrapper>
      <ProTable<TableListItem>
        ...
        request={(params, sorter, filter) => getMultipleTests({ ...params, sorter, filter })}
        columns={columns}
        rowSelection={{}}
      />
